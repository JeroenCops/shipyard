...
impl<T: Component + Send + Sync> IterComponent for &'_ T {
    ...
    fn into_abtract_mut<'a>(
        ...
        error::GetStorage,
    > {
        let view = View::<'a, T>::borrow(all_storages, all_borrow, None, None, current)?;
...
impl<T: Component + Sync> IterComponent for NonSend<&'_ T> {
    ...
    fn into_abtract_mut<'a>(
        ...
        error::GetStorage,
    > {
        let view = NonSend::<View<'a, T>>::borrow(all_storages, all_borrow, None, None, current)?;
...
impl<T: Component + Send> IterComponent for NonSync<&'_ T> {
    ...
    fn into_abtract_mut<'a>(
        ...
        error::GetStorage,
    > {
        let view = NonSync::<View<'a, T>>::borrow(all_storages, all_borrow, None, None, current)?;
...
impl<T: Component> IterComponent for NonSendSync<&'_ T> {
    ...
    fn into_abtract_mut<'a>(
        ...
        error::GetStorage,
    > {
        let view = NonSendSync::<View<'a, T>>::borrow(all_storages, all_borrow, None, None, current)?;
...
impl<T: Component + Send + Sync> IterComponent for &'_ mut T {
    ...
    fn into_abtract_mut<'a>(
        ...
        error::GetStorage,
    > {
        let view = ViewMut::<'a, T>::borrow(all_storages, all_borrow, None, None, current)?;
...
impl<T: Component + Sync> IterComponent for NonSend<&'_ mut T> {
    ...
    fn into_abtract_mut<'a>(
        ...
        error::GetStorage,
    > {
        let view = NonSend::<ViewMut<'a, T>>::borrow(all_storages, all_borrow, None, None, current)?;
...
impl<T: Component + Send> IterComponent for NonSync<&'_ mut T> {
    ...
    fn into_abtract_mut<'a>(
        ...
        error::GetStorage,
    > {
        let view = NonSync::<ViewMut<'a, T>>::borrow(all_storages, all_borrow, None, None, current)?;
...
impl<T: Component> IterComponent for NonSendSync<&'_ mut T> {
    ...
    fn into_abtract_mut<'a>(
        ...
        error::GetStorage,
    > {
        let view = NonSendSync::<ViewMut<'a, T>>::borrow(all_storages, all_borrow, None, None, current)?;
